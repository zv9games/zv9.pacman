...
@onready var nav_agent = $/root/BINARY/MODES/ORIGINAL/INKY/NavigationAgent2D
@onready var pacman = $"/root/BINARY/MODES/ORIGINAL/PACMAN"
@onready var gameboard = $"/root/BINARY/MODES/ORIGINAL/ORIGINALBOARD"
@onready var animatedsprite = $/root/BINARY/MODES/ORIGINAL/INKY/AnimatedSprite2D  
@onready var scoremachine = $/root/BINARY/SCOREMACHINE
@onready var collision_area = $/root/BINARY/MODES/ORIGINAL/INKY/Area2D  
