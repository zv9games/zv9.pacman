...
@onready var nav_agent = $/root/BINARY/MODES/ORIGINAL/PINKY/NavigationAgent2D 
@onready var pacman = $"/root/BINARY/MODES/ORIGINAL/PACMAN"
@onready var gameboard = $"/root/BINARY/MODES/ORIGINAL/ORIGINALBOARD"
@onready var animatedsprite = $/root/BINARY/MODES/ORIGINAL/PINKY/AnimatedSprite2D  
@onready var scoremachine = $/root/BINARY/SCOREMACHINE
@onready var collision_area = $/root/BINARY/MODES/ORIGINAL/PINKY/Area2D  
