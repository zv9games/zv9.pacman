...
@onready var nav_agent = $/root/BINARY/MODES/ORIGINAL/BLINKY/NavigationAgent2D 
@onready var pacman = $"/root/BINARY/MODES/ORIGINAL/PACMAN"
@onready var gameboard = $"/root/BINARY/MODES/ORIGINAL/ORIGINALBOARD"
@onready var animated_sprite = $/root/BINARY/MODES/ORIGINAL/BLINKY/AnimatedSprite2D  
@onready var scoremachine = $/root/BINARY/SCOREMACHINE
@onready var collision_area = $/root/BINARY/MODES/ORIGINAL/BLINKY/Area2D 
