...
var start_position = Vector2(13, 18)
var clyde_position = start_position * tile_size
var is_frozen = false
...
@onready var nav_agent = $/root/BINARY/MODES/ORIGINAL/CLYDE/NavigationAgent2D
...
@onready var collision_area = $/root/BINARY/MODES/ORIGINAL/CLYDE  
@onready var animatedsprite = $"/root/BINARY/MODES/ORIGINAL/CLYDE/AnimatedSprite2D"
