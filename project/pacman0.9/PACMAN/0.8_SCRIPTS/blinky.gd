...
@onready var nav_agent = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/BLINKY/NavigationAgent2D 
...
@onready var animated_sprite = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/BLINKY/AnimatedSprite2D  
@onready var scoremachine = $/root/BINARY/GAME/SCOREMACHINE
@onready var collision_area = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/BLINKY/Area2D 
