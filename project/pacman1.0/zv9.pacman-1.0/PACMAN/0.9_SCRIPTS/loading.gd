...
@onready var pacman2 = $"/root/BINARY/STARTMENU/LOADING/LO_PACMAN"
@onready var blinky2 = $"/root/BINARY/STARTMENU/LOADING/LO_BLINKY"
@onready var pinky2 = $"/root/BINARY/STARTMENU/LOADING/LO_PINKY"
