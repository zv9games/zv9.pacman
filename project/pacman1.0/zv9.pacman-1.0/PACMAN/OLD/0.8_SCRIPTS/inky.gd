...
@onready var nav_agent = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/INKY/NavigationAgent2D
...
@onready var animatedsprite = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/INKY/AnimatedSprite2D  
@onready var scoremachine = $/root/BINARY/GAME/SCOREMACHINE
@onready var collision_area = $/root/BINARY/LEVELS/ORIGINAL/CHARACTERS/INKY/Area2D  
